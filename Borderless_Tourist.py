...
#Test works correctly Value Error for Q13.
...
#Test to see if list recommendation works
...
Erin_egypt = get_attractions_for_travelers(['Erin Wilkes', 'Shanghai, China', ['historical site', 'art']])
print(smills_france)
print(Erin_egypt)
